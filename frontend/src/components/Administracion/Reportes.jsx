        ...
        <div className="flex" style={{ height: "700px" }}>
          ...
          <div className=" ml-4 w-3/4 text-lg overflow-scroll">
            ...
            {incomeReport.incomeSummary ?
              <div>
                <p className="text-lg font-bold flex"><BsCashCoin size={27} className="text-green-700 mr-4 mt-2" />Ingresos en Efectivo: <span className="font-normal text-green-600">+ ${incomeReport.incomeSummary._sum.cashIncome ? incomeReport.incomeSummary._sum.cashIncome : 0}</span></p>
