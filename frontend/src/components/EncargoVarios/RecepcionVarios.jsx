    ...
    <div>
      <div className="mb-3">
        <div className="title-container">
          <strong className="title-strong">Recepción de Encargos Varios</strong>
        </div>
      </div>
      ...
      <div className="fcol-container">
        <button
          ...
          onClick={() => launchModal("/addClient?source=varios")}
        >
...
export default RecepcionVarios;
