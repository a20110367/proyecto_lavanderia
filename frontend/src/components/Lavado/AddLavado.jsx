...
function AddLavado() {
    ...
    const lavadoRef = useRef();
    const errlRef = useRef();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await Axios.post("http://localhost:5000/lavados", {
                precio: precio,
                tipo: tipo,
            ...
            if (!err?.response) {
                ...
                setErrMsg('lavadoname Taken');
            } else {
                setErrMsg('Registration Failed')
            }
            errlRef.current.focus();
        }
    }
        ...
        <div className="signup-form">
            ...
            {success ? (
                ...
                <section className="bg-white px-4 pt-3 pb-4 rounded-sm border vorder-gray-200 flex-1">
                    <p ref={errlRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">{errMsg}</p>
