    ...
    <div>
      <div className="mb-3">
        <div className="title-container">
          <strong className="title-strong">Recepción de Tintoreria</strong>
        </div>
      </div>
              ...
              {filteredClients
                ...
                .map((client, index) => (
                  <tr className="bg-white border-b" key={index}>
                    ...
                    <td>
                      <Link
                        to={`/puntoVenta?clientId=${client.id_client}&clientName=${client.name}&serviceType=Tintoreria&geturl=/servicesDryClean`}
                      >
      ...
      <div className="fcol-container">
        <button
          ...
          onClick={() => launchModal("/addClient?source=tintoreria")}
        >
...
export default RecepcionTintoreria;
